  ...
  return (
    <section className={styles.register}>
      <div className={styles.infoPanel}>
        <p className={styles.eyebrow}>CLINICA ATELIER</p>

        <h2 className={styles.heading}>
          Wszystko, czego potrzebujesz do codziennej pracy z pacjentami.
        </h2>

        <p className={styles.description}>
          Zarządzaj pacjentami, wizytami i dokumentacją w jednym, uporządkowanym
          miejscu.
        </p>
        ...
        <div className={styles.featureGrid}>
          <div className={styles.featureCard}>
            <h3>Pacjenci</h3>
            <p>Dane pacjentów i historia wizyt zawsze pod ręką.</p>
          </div>

          <div className={styles.featureCard}>
            <h3>Wizyty</h3>
            <p>Planuj i kontroluj swój harmonogram pracy.</p>
          </div>
        </div>
      </div>
